export default {
  translation: {
    ...
    "accounts-info":
      "Has autorizado a Big Sister a acceder a los datos de las siguientes cuentas. Puedes seleccionar una para desautorizar y cerrar tu sesión.",
    "accounts-logout-message": "Por favor elige una para desloguearla",
